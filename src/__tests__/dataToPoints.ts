...
describe('dataToPoints', () => {
    ...
    it('should return an array', () => {
        ...
        expect(Array.isArray(dataToPoints({ data: [1, null as any, undefined as any] }))).toBe(true);
    });
    ...
    it('should return y == height for 0 and null values', () => {
        ...
        expect(dataToPoints({ data: [0, null as any, 0] })).toEqual([
            {x: 0, y: 0.5, valid: true},
    ...
    it('should mark invalid values (NaN, Infinity, null, undefined) as invalid', () => {
        const result = dataToPoints({ data: [1, NaN, 2, Infinity, 3, null as any, 4, undefined as any, 5] });
